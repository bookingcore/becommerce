                ...
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <input type="text" class="form-control" name="axtronic_hotline_contact" value="{{setting_item('axtronic_hotline_contact')}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="">{{__("Email Contact")}}</label>
                        <div class="form-controls">
                            <input type="text" class="form-control" name="axtronic_email_contact" value="{{setting_item('axtronic_email_contact')}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>{{__("Footer Style")}}</label>
                        <div class="form-controls">
                            <select name="axtronic_footer_style" class="form-control">
