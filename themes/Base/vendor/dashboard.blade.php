...
@section('content')
    <section class="bc-dashboard">
        <div class="bc-section__left">
            <div class="row">
                <div class="col-md-8">
                    <div class="bc-card bc-card--sale-report">
                        <div class="bc-card__header">
                            <h4>Sales Reports</h4>
                        </div>
                        <div class="bc-card__content" style="position: relative;">
                ...
                <div class="col-md-4">
                    <div class="bc-card bc-card--earning">
                        <div class="bc-card__header">
                            <h4>Earnings</h4>
                        </div>
                        <div class="bc-card__content">
                            <div class="bc-card__chart">
                                ...
                                <div class="bc-card__information"><i class="icon icon-wallet"></i><strong>$12,560</strong><small>Balance</small></div>
            ...
            <div class="bc-card">
                    ...
                    <div class="table-responsive">
                        <table class="table bc-table">
                            ...
                            <tr>
                                ...
                                <td><span class="bc-badge success">Paid</span>
                                </td>
                                <td><span class="bc-fullfillment success">delivered</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><span class="bc-badge gray">Unpaid</span>
                                </td>
                                <td><span class="bc-fullfillment success">delivered</span>
                                </td>
                                <td><strong>$56.00</strong></td>
                            ...
                            <tr>
                                ...
                                <td><span class="bc-fullfillment warning">In Progress</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><span class="bc-fullfillment danger">Cancel</span>
                                </td>
                ...
                <div class="bc-card__footer"><a class="bc-card__morelink" href="orders.htmls">View Full Orders<i class="icon icon-chevron-right"></i></a></div>
            </div>
        </div>
        <div class="bc-section__right">
            <section class="bc-card bc-card--statics">
                <div class="bc-card__header">
                    <h4>Statics</h4>
                    <div class="bc-card__sortby"><i class="icon-calendar-empty"></i>
                ...
                <div class="bc-card__content">
                    <div class="bc-block--stat yellow">
                        <div class="bc-block__left"><span><i class="icon-cart"></i></span></div>
                        <div class="bc-block__content">
                            <p>Orders</p>
                            <h4>254<small class="asc"><i class="icon-arrow-up"></i><span>12,5%</span></small></h4>
                        </div>
                    </div>
                    <div class="bc-block--stat pink">
                        <div class="bc-block__left"><span><i class="icon-cart"></i></span></div>
                        <div class="bc-block__content">
                            <p>Revenue</p>
            ...
            <section class="bc-card bc-card--top-country">
                <div class="bc-card__header">
                    <h4>Top Countries</h4>
                </div>
                <div class="bc-card__content">
