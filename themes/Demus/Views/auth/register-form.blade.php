<form class="bc-form axtronic-form-register" method="post">
    @csrf
    <div class="axtronic-form__content">
        <div class="form-group mb-3">
            <label  for="first_name" class="form-label">{{ __("First Name") }} <span class="required">*</span></label>
            <input type="text" class="form-control mb-1" name="first_name" autocomplete="off" >
            <span class="invalid-feedback error error-first_name"></span>
        </div>
        <div class="form-group mb-3">
            <label  for="last_name" class="form-label">{{ __("Last Name") }} <span class="required">*</span></label>
        ...
        <div class="form-group my-3 d-grid">
            <button type="submit" class="btn btn-signup form-submit"><span>{{__('Sign Up')}}</span></button>
        </div>
    </div>
    @include("auth.social")
</form>
