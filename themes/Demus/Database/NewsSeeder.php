...
class NewsSeeder extends Seeder
{
    ...
    {
        $list_categories = [
            ['name' => 'Music', 'slug' => 'music',  'status' => 'publish' ]
            , ['name' => 'Education', 'slug' => 'education',  'status' => 'publish' ]
            , ['name' => 'Construction', 'slug' => 'construction',  'status' => 'publish' ]
            , ['name' => 'Travel', 'slug' => 'travel',  'status' => 'publish' ]
            , ['name' => 'Apps', 'slug' => 'apps',  'status' => 'publish' ]
            , ['name' => 'Text', 'slug' => 'text',  'status' => 'publish' ]
            , ['name' => 'Tech', 'slug' => 'tech',  'status' => 'publish' ]
            , ['name' => 'Social', 'slug' => 'social',  'status' => 'publish' ]
        ];
        ...
        $media_files = [
            '1'=> MediaFile::updateOrCreate(['file_name' => 'demus-news-1', 'file_path' => 'demus/blog/blog-1.png', 'file_type' => 'image/png', 'file_extension' => 'png'],['file_name' => 'demus-news-1'])->id,
            '2'=> MediaFile::updateOrCreate(['file_name' => 'demus-news-2', 'file_path' => 'demus/blog/blog-2.png', 'file_type' => 'image/png', 'file_extension' => 'png'],['file_name' => 'demus-news-2'])->id,
            '3'=> MediaFile::updateOrCreate(['file_name' => 'demus-news-3', 'file_path' => 'demus/blog/blog-3.png', 'file_type' => 'image/png', 'file_extension' => 'png'],['file_name' => 'demus-news-3'])->id,
            '4'=> MediaFile::updateOrCreate(['file_name' => 'demus-news-4', 'file_path' => 'demus/blog/blog-4.png', 'file_type' => 'image/png', 'file_extension' => 'png'],['file_name' => 'demus-news-4'])->id,
            '5'=> MediaFile::updateOrCreate(['file_name' => 'demus-news-5', 'file_path' => 'demus/blog/blog-5.png', 'file_type' => 'image/png', 'file_extension' => 'png'],['file_name' => 'demus-news-5'])->id,
            '6'=> MediaFile::updateOrCreate(['file_name' => 'demus-news-6', 'file_path' => 'demus/blog/blog-6.png', 'file_type' => 'image/png', 'file_extension' => 'png'],['file_name' => 'demus-news-6'])->id,
        ];
        ...
        DB::table('core_news')->insert([
            'title' => 'In Black and White. The perfect match of all times',
            'slug' => Str::slug('In Black and White. The perfect match of all times', '-'),
            'content' => $content,
            'status' => "publish",
            'cat_id' => rand(1, 4),
        ...
        DB::table('core_news')->insert([
            'title' => 'Face the New Year with The Real Shaving Company!',
            'slug' => Str::slug('Face the New Year with The Real Shaving Company!', '-'),
            'content' => $content,
            'status' => "publish",
            'cat_id' => rand(1, 4),
        ...
        DB::table('core_news')->insert([
            'title' => 'The definitive guide to make more productive flow',
            'slug' => Str::slug('The definitive guide to make more productive flow', '-'),
            'content' => $content,
            'status' => "publish",
            'cat_id' => rand(1, 4),
