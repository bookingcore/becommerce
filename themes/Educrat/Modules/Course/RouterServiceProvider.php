...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Themes\Educrat\Modules\Course\Controllers';

    protected $moduleApiNamespace = 'Themes\Educrat\Modules\Course\Api';

    protected $adminModuleNamespace = 'Themes\Educrat\Modules\Course\Admin';
