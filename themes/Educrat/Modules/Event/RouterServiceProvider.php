...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Themes\Educrat\Modules\Event\Controllers';

    protected $moduleApiNamespace = 'Themes\Educrat\Modules\Event\Api';

    protected $adminModuleNamespace = 'Themes\Educrat\Modules\Event\Admin';
