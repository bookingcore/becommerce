...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace      = 'Plugins\PaymentPayPalPro\Controllers';
    protected $adminModuleNamespace = 'Plugins\PaymentPayPalPro\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware([
            'web',
            'dashboard'
        ])->namespace($this->adminModuleNamespace)->prefix('admin/module/PaymentPayPalPro')->group(__DIR__ . '/Routes/admin.php');
    }
