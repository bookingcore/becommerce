...
class MediaFileSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('media_files')->insert([
            ...
            ['file_name' => 'logo', 'file_path' => 'demo/general/logo.png', 'file_type' => 'image/png', 'file_extension' => 'png'],
        ...
        DB::table('media_files')->insert([
            ...
            ['file_name' => 'news-8', 'file_path' => 'demo/news/news-8.jpg', 'file_type' => 'image/jpeg', 'file_extension' => 'jpg'],
