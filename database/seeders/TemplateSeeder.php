...
class TemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('core_templates')->insert(
            [
                'title' =>  'Home Page',
                'content'   =>  '[{"type":"banner_slider","name":"Banner Slider","model":{"sliders":[{"_active":true,"title":"IKEA Minimalist Otoman","sub_title":"Mega Sale Nov 2021","image":'.$banner_slider_1.',"sub_text":"Discount <strong>50% Off </strong>","btn_shop_now":"Shop Now","link_shop_now":"#"},{"_active":true,"title":"Double Combo With The Body Shop","sub_title":"Mega Sale Nov 2021","image":'.$banner_slider_1.',"sub_text":"Discount <strong>70% Off </strong>","btn_shop_now":"Shop now","link_shop_now":"#"}]},"component":"RegularBlock","open":true,"is_container":false},{"type":"featured_icon","name":"Featured Icon","model":{"list_items":[{"_active":true,"title":"Free Delivery","sub_title":"For all oders over $99","icon":"fa fa-rocket"},{"_active":true,"title":"90 Days Return","sub_title":"If goods have problems","icon":"fa fa-reply"},{"_active":true,"title":" 24/7 Support","sub_title":"Dedicated support","icon":"fa fa-comments-o"}]},"component":"RegularBlock","open":true,"is_container":false},{"type":"promotion","name":"Promotion","model":{"col":"3","list_items":[{"_active":true,"image":'.$promotion_1.',"title":"Promotion 1","link":"#"},{"_active":true,"image":'.$promotion_1.',"title":"Promotion 2","link":"#"},{"_active":true,"image":'.$promotion_1.',"link":"#","title":"Promotion 3"},{"_active":true,"title":"Promotion 4","link":"#","image":'.$promotion_1.'}],"title":"Promotion For You","sub_title":"Recommended for you"},"component":"RegularBlock","open":true,"is_container":false},{"type":"list_product","name":"Product: List item","model":{"style_list":"","title":"Best Seller Brands","sub_title":"Recommended for you","cat_ids":"","number":8,"order":"id","order_by":"desc","is_featured":""},"component":"RegularBlock","open":true},{"type":"list_product","name":"Product: List item","model":{"style_list":"slide","title":"Popular Smartphones & Tablets","sub_title":"Technology Toys Recommended For You","cat_ids":"","number":6,"order":"id","order_by":"asc","is_featured":false},"component":"RegularBlock","open":true}]',
                'create_user' => '1',
                'created_at' =>  date("Y-m-d H:i:s")
            ]
        );
