...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\Plugin\Controllers';

    protected $adminModuleNamespace = 'Modules\Plugin\Admin';

    protected $apiModuleNamespace = 'Modules\Plugin\Api';
