                ...
                <div class="form-group">
                    ...
                    <div class="form-content">
                        ...
                        <div class="smart-search">
                            <input type="text" name="location_name" class="smart-search-location parent_text form-control" {{ ( empty(setting_item("space_location_search_style")) or setting_item("space_location_search_style") == "normal" ) ? "readonly" : ""  }} placeholder="{{__("Where are you going?")}}" value="{{ !empty(Request::query('location_id')) ? Request::query('location_name') : ''}}" data-onLoad="{{__("Loading...")}}"
            ...
            <div class="col-md-4 border-right dropdown form-select-guests">
                <div class="form-group">
                    ...
                    <div class="dropdown-menu select-guests-dropdown" >
                        <input type="hidden" name="adults" value="{{request()->query('adults',1)}}" min=1 max=20 value=1>
                        <input type="hidden" name="children" value="{{request()->query('children',0)}}" min=0 max=20 value=0>
