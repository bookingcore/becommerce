...
<div class="form-group mb-3 align-items-center" data-condition="product_type:not(external)">
...
<div class="form-group mb-3" data-condition="is_manage_stock:is(),product_type:not(external)">
...
<div class="form-group mb-3" data-condition="is_manage_stock:is(1),product_type:not(external)">
