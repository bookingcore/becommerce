@if(is_default_lang())
    @foreach ($attributes as $attribute)
        <div class="form-group">
            ...
            <div class="controls">
                <label data-condition="product_type:is(variable)"><input type="checkbox" name="attributes_for_variation[]" @if(in_array($attribute->id,$product->attributes_for_variation)) checked @endif value="{{$attribute->id}}"> {{__("Used for variations")}}</label>
                <div class="">
