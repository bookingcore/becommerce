...
@section('content')
    <div class="container-fluid">
        <h3 class="mt-2 mt-md-4 mb-4">{{ __("Orders") }}</h3>
        <form method="GET" action="{{ route('report.admin.orders') }}" class="filter-form filter-form-left d-flex justify-content-start">
        ...
        <div class="row pt-2 mb-4">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="summary-card card mb-3">
                    <div class="card-content">
                        <span class="card-title">Average items per order</span>
                        <span class="card-amount">0</span>
                    </div>
                    <div class="card-media">
                        <i class="icon ion-ios-cart"></i>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="summary-card card mb-3">
                    <div class="card-content">
                        <span class="card-title">Average order value</span>
                        <span class="card-amount">$0.00</span>
                    </div>
                    <div class="card-media">
                        <i class="icon ion-ios-pricetags"></i>
