...
@section('content')
    ...
    {{--<div class="woocommerce">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-7 col-form-login">
                ...
                <form class="woocommerce-form woocommerce-form-login login" method="post" style="display:none">
                    ...
                    <p class="form-row">
                        <label
                            class="woocommerce-form__label woocommerce-form__label-for-checkbox inline woocommerce-form-login__rememberme">
                        ...
                        <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce"
                               value="2ee8cc437e"><input type="hidden" name="_wp_http_referer"
                                                         value="/martfury3/checkout/"> <input type="hidden"
                                                                                              name="redirect"
                                                                                              value="http://demo2.drfuri.com/martfury3/checkout/">
                        <button type="submit" class="woocommerce-button button woocommerce-form-login__submit"
                                name="login" value="Login">Login
                        </button>
                    </p>
                    <p class="lost_password">
                        <a href="http://demo2.drfuri.com/martfury3/my-account/lost-password/">Lost your password?</a>
                    </p>
            ...
            <div class="col-xs-12 col-sm-12 col-form-coupon col-md-5">
        ...
        <form name="checkout" method="post" class="checkout woocommerce-checkout" action="http://demo2.drfuri.com/martfury3/checkout/" enctype="multipart/form-data" novalidate="novalidate">
            <div class="row">
                            ...
                            <div class="woocommerce-billing-fields">
                                ...
                                <div class="woocommerce-billing-fields__field-wrapper">
                                    ...
                                    <p class="form-row form-row-wide" id="billing_company_field" data-priority="30">
                                        <label for="billing_company" class="">Company name&nbsp;<span class="optional">(optional)</span></label><span
                                            class="woocommerce-input-wrapper"><input type="text" class="input-text "
                                    ...
                                    <p class="form-row form-row-wide address-field update_totals_on_change validate-required"
                                       id="billing_country_field" data-priority="40"><label for="billing_country"
                                            ...
                                            class="woocommerce-input-wrapper"><select name="billing_country"
                                                    ...
                                                    value="">Select a country / region…</option><option value="AX">Åland Islands</option><option
                                                    ...
                                                    value="MO">Macao</option><option value="MG">Madagascar</option><option
                                    ...
                                    <p class="form-row form-row-wide address-field" id="billing_address_2_field"
                                       data-priority="60"><label for="billing_address_2" class="screen-reader-text">Apartment,
                                    ...
                                    <p class="form-row form-row-wide address-field validate-required"
                                       ...
                                       data-o_class="form-row form-row-wide address-field validate-required"><label
                                            for="billing_city" class="">Suburb&nbsp;<abbr class="required"
                                       ...
                                       data-o_class="form-row form-row-wide address-field validate-required validate-state">
                                        <label for="billing_state" class="">State&nbsp;<abbr class="required"
                                            ...
                                            class="woocommerce-input-wrapper"><select name="billing_state"
                                                                                      ...
                                                                                      data-input-classes=""
                                                                                      tabindex="-1" aria-hidden="true"><option
                                                    value="">Select an option…</option><option value="ACT">Australian Capital Territory</option><option
                                                    value="NSW">New South Wales</option><option value="NT">Northern Territory</option><option
                                                    value="QLD">Queensland</option><option
                                                    value="SA">South Australia</option><option
                                    ...
                                    <p class="form-row form-row-wide validate-required validate-phone"
                                       id="billing_phone_field" data-priority="100"><label for="billing_phone" class="">Phone&nbsp;<abbr
                                                class="required" title="required">*</abbr></label><span
                                    ...
                                    <p class="form-row form-row-wide validate-required validate-email"
                                       id="billing_email_field" data-priority="110"><label for="billing_email" class="">Email
                            ...
                            <div class="woocommerce-account-fields">
                                ...
                                <div class="create-account" style="display: none;">
                                    <p class="form-row validate-required" id="account_password_field" data-priority="">
                                        <label for="account_password" class="">Create account password&nbsp;<abbr
                                                class="required" title="required">*</abbr></label><span
                                    ...
                                    <div class="woocommerce-shipping-fields__field-wrapper">
                                        ...
                                        <p class="form-row form-row-last validate-required"
                                           id="shipping_last_name_field" data-priority="20"><label
                                                for="shipping_last_name" class="">Last name&nbsp;<abbr class="required"
                                                                                                       title="required">*</abbr></label><span
                                                class="woocommerce-input-wrapper"><input type="text" class="input-text "
                                        ...
                                        <p class="form-row form-row-wide address-field update_totals_on_change validate-required"
                                           id="shipping_country_field" data-priority="40"><label for="shipping_country"
                                                ...
                                                class="woocommerce-input-wrapper"><select name="shipping_country"
                                                        ...
                                                        value="PS">Palestinian Territory</option><option value="PA">Panama</option><option
                                                        value="PG">Papua New Guinea</option><option
                                                        value="PY">Paraguay</option><option value="PE">Peru</option><option
                                                        ...
                                                        value="TL">Timor-Leste</option><option value="TG">Togo</option><option
                                                        value="TK">Tokelau</option><option value="TO">Tonga</option><option
                                                        value="TT">Trinidad and Tobago</option><option value="TN">Tunisia</option><option
                                           ...
                                           data-o_class="form-row form-row-wide address-field validate-required validate-state">
                                            <label for="shipping_state" class="">State&nbsp;<abbr class="required"
                                                ...
                                                class="woocommerce-input-wrapper"><select name="shipping_state"
                                                        ...
                                                        value="TAS">Tasmania</option><option
                                                        value="VIC">Victoria</option><option value="WA">Western Australia</option></select><span
                                                    class="select2 select2-container select2-container--default"
                                                    dir="ltr" style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single"
                                                            aria-haspopup="true" aria-expanded="false" tabindex="0"
                                        ...
                                        <p class="form-row form-row-wide address-field validate-required validate-postcode"
                                           ...
                                           data-o_class="form-row form-row-wide address-field validate-required validate-postcode">
                                            <label for="shipping_postcode" class="">Postcode&nbsp;<abbr class="required"
                                                                                                        title="required">*</abbr></label><span
                                                class="woocommerce-input-wrapper"><input type="text" class="input-text "
                        ...
                        <table class="shop_table woocommerce-checkout-review-order-table">
                            ...
                            <tr class="cart_item">
                                <td class="product-name">
                                    Korea Long Sofa Fabric In Blue Navy Color&nbsp; <strong class="product-quantity">×&nbsp;1</strong>
                                    <dl class="variation">
                                        <dt class="variation-SoldBy">Sold By:</dt>
                                        <dd class="variation-SoldBy"><p>YOUNG SHOP</p>
                                        </dd>
                                    </dl>
                                </td>
                                <td class="product-total">
                                    <span class="woocommerce-Price-amount amount"><span
                                            class="woocommerce-Price-currencySymbol">$</span>567.99</span></td>
                            </tr>
                            <tr class="cart_item">
                                <td class="product-name">
                                    LG White Front Load Steam Washer&nbsp; <strong
                                        class="product-quantity">×&nbsp;1</strong>
                                    <dl class="variation">
                                        <dt class="variation-SoldBy">Sold By:</dt>
                                        <dd class="variation-SoldBy"><p>ROBERT’S STORE</p>
                                        </dd>
                                    </dl>
                                </td>
                                <td class="product-total">
                                    <span class="woocommerce-Price-amount amount"><span
                                            class="woocommerce-Price-currencySymbol">$</span>1,025.50</span></td>
                            </tr>
                            <tr class="cart_item">
                                <td class="product-name">
                                    Set 30 Piece Korea StartSkin Natural Mask&nbsp; <strong class="product-quantity">×&nbsp;1</strong>
                                    <dl class="variation">
                                        <dt class="variation-SoldBy">Sold By:</dt>
                                        <dd class="variation-SoldBy"><p>ROBERT’S STORE</p>
                                        </dd>
                                ...
                                <td class="product-total">
                                    <span class="woocommerce-Price-amount amount"><span
                                            class="woocommerce-Price-currencySymbol">$</span>32.75</span></td>
                            </tr>
                            </tbody>
                            <tfoot>
                            ...
                            <tr class="cart-subtotal">
                                ...
                                <td><span class="woocommerce-Price-amount amount"><span
                                            class="woocommerce-Price-currencySymbol">$</span>1,626.24</span></td>
                            </tr>
                            ...
                            <tr class="woocommerce-shipping-totals shipping">
                                <td colspan="2" data-title="YOUNG SHOP Shipping">
                                    ...
                                    <ul id="shipping_method" class="woocommerce-shipping-methods">
                                        <li>
                                            <input type="hidden" name="shipping_method[234]" data-index="234"
                                                   id="shipping_method_234_free_shipping1" value="free_shipping:1"
                                                   class="shipping_method"><label
                                                for="shipping_method_234_free_shipping1">Free shipping</label></li>
                                    </ul>

                                    <p class="woocommerce-shipping-contents"><small>Korea Long Sofa Fabric In Blue Navy
                                            Color ×1</small></p></td>
                            </tr>
                            <tr class="woocommerce-shipping-totals shipping">
                                <td colspan="2" data-title="ROBERT’S STORE Shipping">
                                    ...
                                    <ul id="shipping_method" class="woocommerce-shipping-methods">
                                        <li>
                                            <input type="hidden" name="shipping_method[235]" data-index="235"
                                                   id="shipping_method_235_free_shipping1" value="free_shipping:1"
                                                   class="shipping_method"><label
                                                for="shipping_method_235_free_shipping1">Free shipping</label></li>
                                    </ul>

                                    <p class="woocommerce-shipping-contents"><small>LG White Front Load Steam Washer ×1,
                                            Set 30 Piece Korea StartSkin Natural Mask ×1</small></p></td>
                            </tr>
                            ...
                            <tr class="order-total">
                                ...
                                <td><strong><span class="woocommerce-Price-amount amount"><span
                                                class="woocommerce-Price-currencySymbol">$</span>1,626.24</span></strong>
                                </td>
                            </tr>
                        ...
                        <div id="payment" class="woocommerce-checkout-payment">
                            <ul class="wc_payment_methods payment_methods methods">
                                ...
                                <li class="wc_payment_method payment_method_paypal">
                                    ...
                                    <label for="payment_method_paypal">
                                        PayPal <img
                                            src="https://www.paypalobjects.com/webstatic/en_AU/mktg/logo/Solutions-graphics-1-184x80.jpg"
                                            alt="PayPal acceptance mark"><a
                                            href="https://www.paypal.com/au/webapps/mpp/paypal-popup"
                                            class="about_paypal"
                                            onclick="javascript:window.open('https://www.paypal.com/au/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;">What
                                            is PayPal?</a> </label>
                            ...
                            <div class="form-row place-order">
                                ...
                                <input type="hidden" id="woocommerce-process-checkout-nonce"
                                       name="woocommerce-process-checkout-nonce" value="06aa11fccd"><input type="hidden"
                                                                                                           name="_wp_http_referer"
                                                                                                           value="/martfury3/?wc-ajax=update_order_review">
                            </div>
                        </div>
